...
Ferramenta Uso Power BI Desktop Construção do dashboard e visualizações Power Query ETL e tratamento dos dados DAX Criação de medidas e KPIs calculadosExcelBase de dados fonte
